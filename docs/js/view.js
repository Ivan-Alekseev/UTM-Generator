function UIctrl (ctrl) {
    let link, linkValue,
        listSources, listSourcesInput, yoursVariantSource,
        listMedium, listMediumInput, yoursVariantMedium,
        campaignInput, contentInput, termInput,
        buttonGenerate, buttonReset, buttonCopy, readyLink;
    ...
    yoursVariantMedium = document.querySelector(".yours_variant_medium > input[type=text]");
    //--------// choice of medium ------------//
